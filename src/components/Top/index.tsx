  ...
  return (
    <div>
      <div className="py-8 sm:flex  justify-center  ">
        <Icon src={src} className="mx-auto my-auto sm:mx-4" />
          ...
          >
            <Link href={menu.href} className="">
              {menu.category == category ? (
                <>
                  <p className="text-center text-[color:var(--link)] font-bold text-lg xs:text-2xl py-3  leading-normal">
                    {menu.category}
                  </p>
                  <div className="bg-[color:var(--link)] rounded-full h-1 w-1/2 mx-auto"></div>
                </>
              ) : (
                <p className="text-center text-lg xs:text-2xl py-3  leading-normal">
                  {menu.category}
                </p>
              )}
            </Link>
