...
date: 2023-07-24
tags: ["Tech", "Linux", "VoidLinux"]
published: true
---

## はじめに

![Void Linux with i3](void_linux.jpeg)
...
筆者はこれまで、 Debian や Ubuntu Server などを普段使いしてきた。これらは自由度の高さと安定性を兼ね備える優れたディストロである一方、
...
- クロ."Void Linux を UEFI + GPT 環境にインストールして最小環境を構築する".クロの思考ノート.August 13, 2022.[https://note.kurodigi.com/voidlinux-uefi-install/](https://note.kurodigi.com/voidlinux-uefi-install/), 2023/7/24
